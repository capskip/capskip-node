...
If you discover a security vulnerability in the CapSkip Node.js SDK, please report it responsibly.
...
This policy covers the `capskip` npm package in this repository.
